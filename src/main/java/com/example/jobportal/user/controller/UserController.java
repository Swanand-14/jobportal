...
//import com.example.jobportal.dto.ApplyJobRequestDto;
...
import com.example.jobportal.user.service.IUserService;
...
public class UserController {
    ...
    public ResponseEntity<byte[]> getProfilePicture(Authentication authentication) {
        String userEmail = authentication.getName();
        com.example.jobportal.dto.ProfileDto profileDto = userService.getProfilePicture(userEmail);
    ...
    public ResponseEntity<byte[]> getResume(Authentication authentication) {
        String userEmail = authentication.getName();
        com.example.jobportal.dto.ProfileDto profileDto = userService.getResume(userEmail);
