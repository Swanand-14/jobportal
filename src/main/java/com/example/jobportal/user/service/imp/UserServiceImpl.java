package com.example.jobportal.user.service.imp;
...
//    private final JobApplicationRepository jobApplicationRepository;
    ...
    public UserDto elevateToEmployer(Long userId) {
        ...
        if (!"ROLE_EMPLOYER".equals(user.getRole().getName())) {
        ...
        // Find ROLE_EMPLOYER
        Role employerRole = roleRepository.findRoleByName("ROLE_EMPLOYER")
